...
void MainWindow::updateIndex()
{
    ...
    for(int num=oldsize;num<qfile.size();num++)
    {
     ...
     QString js2 = "{\"index\":{}}\n";
     js2.append( "{\"ecuid\":\""+ qmsg.getEcuid() + "\",");
     js2.append( "\"apid\":\""+ qmsg.getApid() + "\",");
     js2.append( "\"subtype\":\""+ qmsg.getSubtypeString() + "\",");
     js2.append( "\"time\":\""+ qmsg.getTimeString() + "\",");
     js2.append( "\"dlt_index\":\""+ QString::number(temp_index++) + "\"");
     js2.append("}\n");
